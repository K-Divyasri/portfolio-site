...
const PROJECTS = [
  ...
  { title: "Document Summarizer", track: "ai", desc: "Map-reduce summarizer for documents too long to fit in one context window.", tags: ["LLM", "Chunking"], repo: GH + "04-document-summarizer" },
  ...
  { title: "dbt Analytics Engineering", track: "data", desc: "Turns raw e-commerce data into tested, documented dbt marts.", tags: ["dbt", "Data Modeling"], repo: GH + "05_dbt_analytics_engineering" },
  ...
  // ---- Health Tech ------------------------------------------------------
  { title: "HIPAA De-identification Pipeline", track: "health", desc: "Safe Harbor eighteen-identifier redaction with date shifting, verified leak-free against a synthetic patient set.", tags: ["HIPAA", "Privacy"], metric: "2,172 redactions, zero leaks", featured: true, repo: GH + "01_hipaa_deidentification" },
